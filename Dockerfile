...
RUN dotnet build "OrderEventProcessor.csproj" -c $BUILD_CONFIGURATION -o /app/build

FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "OrderEventProcessor.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
